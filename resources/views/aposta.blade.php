  ...
  <div class="border" style="margin-left:35%;margin-right:35%;margin-top:5%">
    ...
    <form method="post" action="#">
      ...
      <div class="form-group">
        ...
        <select class="custom-select mr-sm-2" change="name" id="typegame" name="typegame" style="width:">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" placeholder="" id="valor" name="valor" required style="width:">
      </div>
      ...
      <button type="submit" class="btn btn-primary btn-block">Salvar</button><br><br>
